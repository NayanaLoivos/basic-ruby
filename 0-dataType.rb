...
#String é o que está entre aspas duplas ou simples.
    #Qual a diferença?
        #É na concatenação de string, onde se temos aspas duplas
        #conseguimos concatenar assim: "#{}" e se temoa aspas 
...
#Symbol
    ...
    puts nome_string["name"] #nao ta funcionando
    puts nome_symbol[:name]

#PS: .class pode ser digitado sobre qualquer variável e saber e qual tipo ela é.